...
public class SessionManagerService : System.Web.Services.Protocols.SoapHttpClientProtocol, ISessionManager {
    
	public SessionHeader sessionHeader = null;

    /// <remarks/>
    public SessionManagerService(string ipAddr, int port, string sessionId) {
        this.Url = "http://" + ipAddr + ":" + port + "/ProjectServer/services/SessionManager";
