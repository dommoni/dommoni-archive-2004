...
public class ProjectManagerService : System.Web.Services.Protocols.SoapHttpClientProtocol, IProjectManager {
    
	public SessionHeader sessionHeader = null;

    /// <remarks/>
    public ProjectManagerService(string ipAddr, int port, string sessionId) {
        this.Url = "http://"+ipAddr+":"+port+"/ProjectServer/services/ProjectManager";
