...
public class ForumManagerService : System.Web.Services.Protocols.SoapHttpClientProtocol, IForumManager {
    
	public SessionHeader sessionHeader = null;

    /// <remarks/>
    public ForumManagerService(string ipAddr, int port, string sessionId) {
        this.Url = "http://"+ipAddr+":"+port+"/ProjectServer/services/ForumManager";
