...
public class RecentChangesManagerService : System.Web.Services.Protocols.SoapHttpClientProtocol, IRecentChangesManager {
    
	public SessionHeader sessionHeader = null;

    /// <remarks/>
    public RecentChangesManagerService(string ipAddr, int port, string sessionId) {
        this.Url = "http://"+ipAddr+":"+port+"/ProjectServer/services/RecentChangesManager";
