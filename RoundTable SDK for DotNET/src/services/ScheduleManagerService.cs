...
public class ScheduleManagerService : System.Web.Services.Protocols.SoapHttpClientProtocol, IScheduleManager
{
    public SessionHeader sessionHeader = null;

	/// <remarks/>
	public ScheduleManagerService(string ipAddr, int port, string sessionId) 
	{
		this.Url = "http://"+ipAddr+":"+port+"/ProjectServer/services/ScheduleManager";
