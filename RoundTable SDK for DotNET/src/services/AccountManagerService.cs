...
public class AccountManagerService : System.Web.Services.Protocols.SoapHttpClientProtocol, IAccountManager {
    
	public SessionHeader sessionHeader = null;

    /// <remarks/>
    public AccountManagerService(string ipAddr, int port, string sessionId) 
	{
        this.Url = "http://" + ipAddr + ":" + port + "/ProjectServer/services/AccountManager";
