...
public class NotificationManagerService : System.Web.Services.Protocols.SoapHttpClientProtocol, INotificationManager {
    
	public SessionHeader sessionHeader = null;

    /// <remarks/>
    public NotificationManagerService(string ipAddr, int port, string sessionId) {
        this.Url = "http://"+ipAddr+":"+port+"/ProjectServer/services/NotificationManager";
