	...
	<h1>Members</h1>
	  ...
	  if(projectMembers != null && projectMembers.length > 0)
	  {
		  ...
		  for(int i = 0; i < projectMembers.length; i++)
		  {
		      %><tr>
				  <td width="275">
				    <a href="projectMembersViewMember.jsp?accountid=<%=projectMembers[i].getId()%>"><font face="Verdana, Arial, Helvetica, sans-serif"><%=projectMembers[i].getName()%></font></a> 
				    <%
	  ...
	  else
	  {
	   ...
	   %>This project currently has no members available.<%
	  }
	  %>
    </div>
