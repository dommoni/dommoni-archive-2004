...
<tr> <td rowspan="7" colspan="2">&nbsp;</td><td><FONT FACE="Arial, Helvetica, sans-serif" SIZE="2"><B>Title:</B></FONT></td><td colspan="2"><FONT FACE="Arial, Helvetica, sans-serif" SIZE="2"><%=announcement.getTitle()%></font></td><td><FONT SIZE="2" FACE="Arial, Helvetica, sans-serif">From:</FONT></td><td colspan="3">&nbsp;</td><td rowspan="3" colspan="4">&nbsp;</td><td><img src="images/spacer.gif" width="1" height="16" border="0"></td></tr> 
