	  ...
	  <!-- PAGE TEXT GOES HERE -->
	      ...
	      %><form name="form1" method="post" action="./servlet/ControllerServlet">
            ...
            <p> 
              ...
              <input type="hidden" name="opcode" value="<%=Operations.POST_FORUM_REPLY%>">
...
<%--
//
// $Log: projectForumsPostReply.jsp,v $
// Revision 1.2  2005/03/15 18:27:41  Brian Abbott
// Removed "Show Things Todo" box.
//
//
--%>
