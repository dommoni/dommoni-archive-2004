...
<input name="opparam" type="hidden" value="<%=request.getParameter("opparam")%>">
<input name="context" type="hidden" value="<%=request.getParameter("context")%>">
<input name="parentlink" type="hidden" value="<%=request.getParameter("parentlink")%>">
<input name="opcode" type="hidden" value="<%=Operations.CREATE_FILE_ATTACHMENT%>">
</form>
</body>
</html>
<%-- 

$Log: projectAttachmentsAddAttachmentWiz2File.jsp,v $
Revision 1.2  2005/10/16 07:16:39  brian
Initial Revision.
