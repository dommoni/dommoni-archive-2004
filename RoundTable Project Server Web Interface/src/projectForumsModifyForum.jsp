	...
	<h1>Modify Forum Topic</h1>
	  ...
	  <!-- PAGE TEXT GOES HERE -->
	      ...
	      <form name="form1" method="post" action="./servlet/ControllerServlet">
            <p>Topic: 
              <input type="text" name="subject" value="<%=forum.getSubject()%>">
            </p>
            <p>Message: </p>
            <p> 
              <textarea name="message" cols="40" rows="10"><%=forum.getMessage()%></textarea>
              <br>
              <input type="submit" name="Submit" value="Submit">
              <input type="button" name="Submit2" value="Cancel" onClick="MM_callJS('window.history.go(-1)')">
              <input type="hidden" name="opcode" value="<%=Operations.EDIT_FORUM%>">
