...
<%@page import="com.dommoni.roundtable.projectServer.services.recentChangesManager.IRecentChangesManager" %>
...
<div class="Shadow" id="Shadow">
	...
	<h1>Project Change History</h1>
	  ...
	  if(recentChanges != null && recentChanges.length > 0)
	  {
		  ...
		  {
			 %><li><%=recentChanges[i].getChangeMessage()%></li><%
		  }
	  }
	  else
	  {
	     %><p>No changes currently exist for this project.</p><%
	  }
	  %>
	  </ul>
    </div>
...
<%--
*
* $Log: adminProjectsViewProjectChangeHistory.jsp,v $
* Revision 1.2  2005/10/16 06:50:15  brian
* Added else condition for Changes List.
*
* Revision 1.1  2005/03/28 16:41:20  brian
* Initial Revision.
*
*
--%>