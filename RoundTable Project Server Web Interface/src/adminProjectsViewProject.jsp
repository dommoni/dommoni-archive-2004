...
<div class="Sidebar">        
	...
	<ul id="MTabs">
		...
		<li><a href="./adminProjectsViewProjectChangeHistory.jsp?projectId=<%=project.getId()%>">View Change History</a></li>	  
	</ul>
     <br/>
    <br/>    
	<p>&nbsp;</p>
...
<%--
*
* $Log: adminProjectsViewProject.jsp,v $
* Revision 1.2  2005/03/28 16:44:06  brian
* Changed members to be presented as an Unordered list. Added
* Change History link as well.
*
*
--%>