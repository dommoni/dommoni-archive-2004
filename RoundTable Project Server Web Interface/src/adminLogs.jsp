	     ...
	     <form name="form1" method="post" action="./servlet/ControllerServlet">
			 ...
			 <select name="projects" size="5" MULTIPLE>
			    <option value="all" selected>All Projects</option>
					...
					{
					   %><option value="<%=allProjects[i].getId()%>"><%=allProjects[i].getName()%></option><%
					}
					%>
			 </select>
			 ...
			 <select name="accounts" size="5" MULTIPLE>
					...
					{
					   %><option value="<%=allAccounts[i].getId()%>"><%=allAccounts[i].getName()%></option><%
					}
					%>
			 </select>
			 <br><br><b>Select Period:</b></p><p>From: <input type="text" name="from"> <img src="images/icon_calendar.gif" width="22" height="21" align="ABSMIDDLE"><br>To: <input type="text" name="to"> <img src="images/icon_calendar.gif" width="22" height="21" align="ABSMIDDLE"><br><br><input type="hidden" name="opcode" value="<%=Operations.GENERATE_LOG_REPORT%>"></p><p><input type="submit" name="Submit" value="Generate Report"></p></form></div></div><div class="Right">
