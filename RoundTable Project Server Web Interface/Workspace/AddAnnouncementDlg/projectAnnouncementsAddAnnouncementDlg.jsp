<html>
<head>
<title>projectAnnouncementsAddAnnouncementDlg.jsp.gif</title> <meta http-equiv="Content-Type" content="text/html;"> 
...
<FORM NAME="form1" METHOD="post" ACTION=""> <table border="0" cellpadding="0" cellspacing="0" width="450"> 
<!-- fwtable fwsrc="AddAnnouncementDlg.png" fwbase="projectAnnouncementsAddAnnouncementDlg.jsp.gif" fwstyle="Generic" fwdocid = "742308039" fwnested=""0" --> 
...
<tr> <td rowspan="4"><img name="projectAnnouncementsAddAnnouncementDlgjsp_r7_c4" src="images/projectAnnouncementsAddAnnouncementDlg.jsp_r7_c4.gif" width="2" height="228" border="0"></td><td colspan="6" VALIGN="TOP"><TEXTAREA NAME="textfield" COLS="45" ROWS="5"></TEXTAREA></td><td rowspan="2"><img name="projectAnnouncementsAddAnnouncementDlgjsp_r7_c11" src="images/projectAnnouncementsAddAnnouncementDlg.jsp_r7_c11.gif" width="12" height="200" border="0"></td><td><img src="images/spacer.gif" width="1" height="108" border="0"></td></tr> 
